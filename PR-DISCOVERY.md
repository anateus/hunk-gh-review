...
Outdated discussions and their replies remain visible with an `outdated` label. Selecting one doesn't navigate to its obsolete line number. Current threads retain line navigation.
