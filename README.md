...
This fork of [phl28/hunk-gh-review](https://github.com/phl28/hunk-gh-review) adds PR discovery for renamed worktree branches, readable outdated discussions, and switchable Markdown rendering.
...
```bash
hunk extension install anateus/hunk-gh-review
```
...
If you already installed the upstream extension, switch its source once:

```bash
hunk extension remove hunk-gh-review
hunk extension install anateus/hunk-gh-review
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/anateus/hunk-gh-review/main/scripts/hpr -o ~/.local/bin/hpr
